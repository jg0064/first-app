...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/1.9.1/x86_64-darwin10.4.0")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/jesseguzman/.rvm/rubies/ruby-1.9.2-p0")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/jesseguzman/.rvm/rubies/ruby-1.9.2-p0' '--enable-shared'"
  CONFIG["vendordir"] = "$(rubylibprefix)/vendor_ruby"
  CONFIG["sitedir"] = "$(rubylibprefix)/site_ruby"
  CONFIG["ruby_version"] = "1.9.1"
  CONFIG["sitearch"] = "$(arch)"
  CONFIG["arch"] = "x86_64-darwin10.4.0"
  ...
  CONFIG["target"] = "x86_64-apple-darwin10.4.0"
  ...
  CONFIG["build"] = "i386-apple-darwin10.4.0"
