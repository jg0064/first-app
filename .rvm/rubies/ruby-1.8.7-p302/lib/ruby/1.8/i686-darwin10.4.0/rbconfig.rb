...
module Config
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/1.8/i686-darwin10.4.0")
  DESTDIR = '' unless defined? DESTDIR
  CONFIG = {}
  CONFIG["DESTDIR"] = DESTDIR
  CONFIG["INSTALL"] = '/usr/bin/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/jesseguzman/.rvm/rubies/ruby-1.8.7-p302")
  CONFIG["ruby_install_name"] = "ruby"
  CONFIG["RUBY_INSTALL_NAME"] = "ruby"
  CONFIG["RUBY_SO_NAME"] = "ruby"
  CONFIG["MANTYPE"] = "doc"
  CONFIG["NROFF"] = "/usr/bin/nroff"
  CONFIG["configure_args"] = " '--prefix=/Users/jesseguzman/.rvm/rubies/ruby-1.8.7-p302' '--enable-shared'"
  CONFIG["vendordir"] = "$(libdir)/ruby/vendor_ruby"
  CONFIG["sitedir"] = "$(libdir)/ruby/site_ruby"
  CONFIG["sitearch"] = "i686-darwin10.4.0"
  CONFIG["arch"] = "i686-darwin10.4.0"
